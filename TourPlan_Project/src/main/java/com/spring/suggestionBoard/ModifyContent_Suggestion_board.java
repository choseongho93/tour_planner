...
public class ModifyContent_Suggestion_board implements Suggestion_boardService {
	...
	@Override
		public void execute(Model model) {
			...
			String num = request.getParameter("num");//몇 번째 게시글인지 확인
			
			dto = dao.ViewContent_Suggestion_board(num);//기존의 정보를 가져온다.
			

			String subject = request.getParameter("indexOfModiSuggestionBoard");
			String title = request.getParameter("ModiSuggestionBoardTitle");
			String content = request.getParameter("modiSuggestionBoardContent");
	    ...
	    //    dto.setId(id);//아이디
	     ...
	     //   System.out.println("originalName1이 null인가 : " + bool);//null은 아님.
	      ...
	      dao.modifyTipBoard(dto, num, lastImgNum);  
		}
